...
raytracer.{cpp, h} 
The main body of the raytracer. Ray casting and simple scene traversal are provided to you.  

util.{cpp, h}
Includes definitions and implementations for points, vectors, matrices, 
and some structures for intersection, shading, camera, image handling. 
